...
<body>
    ...
    <div id="text_bg">
        <br>
        <br>
        <a href="komiksy.php"> <?php $db_conn->show_image("komiksy"); ?></a>
        <br>
        <a href="ubrania.php"> <?php $db_conn->show_image("ubrania"); ?></a>
        <br>
        <a href="eventy.php"> <?php $db_conn->show_image("eventy"); ?></a>
        <br>
